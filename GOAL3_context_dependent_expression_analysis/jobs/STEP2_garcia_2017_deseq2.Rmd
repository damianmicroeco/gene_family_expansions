---
title: "Garcia 2017 Differential Expression"
...
## Preface
The goal of this script is to determine if larger AM-specific orthogroups have higher frequencies of context dependent expression than smaller AM-specific orthogroups. This data is that from Garcia 2017 which analyzes roots from Medicago truncatula in the presence of the potassium deprivation +/- the arbuscular mycorrhizal fungus Rhizophagus irregularis. I realigned the raw sequencing reads to a RefSeq reference because raw processed read counts were not provided by the paper (although FPKM values are).
...
featurecounts = read.csv("../raw_data/garcia2017_featurecounts_refseq.txt", row.names = 1, header = TRUE, sep = "\t")
...
#load metadata
exp_metadata = read.csv("../metadata/garcia2017_metadata.csv", header = TRUE, row.names = 1)
...
gen_data = read.table("../metadata/orthogroup_identified_AM_medicago_truncatula_genome_metadata.tsv", 
...
write.csv(df_to_save, "../processed_data/transcriptome_relationships/garcia2017_root.csv")
