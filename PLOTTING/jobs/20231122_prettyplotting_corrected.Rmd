...
clust_df = read.csv("../intermediate_data/20220517_heatmap_clustering_noplastid_clusteringidsmatchingheatmap.csv") #this one now has the correct orthogroups that are not plastid genes. See note below about why I removed plastid genes.
...
sig_df = sig_df[sig_df$X %in% clust_df$ortho,]
